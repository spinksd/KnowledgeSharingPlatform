...
urlpatterns = [
    ...
    path('forgotten_password/', auth_views.PasswordResetView.as_view(template_name='users/forgotten_password.html'), name='forgotten_password'),
...
# Slight alternative implementation to one suggested by Django: https://docs.djangoproject.com/en/2.1/howto/static-files/#serving-files-uploaded-by-a-user-during-development
# Ensures this is the method that Media is served in debug mode - as it's not suitable for production use
if settings.DEBUG:
